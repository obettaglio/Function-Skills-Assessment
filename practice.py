...
def sign_and_parity(num):
    ...
    # sign, parity = sign_parity_list       <- unpacked list into variables
    # print sign                               (commented out because
    # print parity                              caused tests to fail)
...
#note:
#directions call for period after SENDER_NAME,
#but program tests for no period
